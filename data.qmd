...
df_list <-
  ...
  mutate(
    ...
    Download = glue::glue("<a href='{url}.xlsx'><img src='img/excel.svg' width = 25 height = 25 alt = 'Excel'></a> <a href='{url}.csv'><img src='img/csv.svg' width = 25 height = 25 alt = 'CSV'></a> <a href='{url}.dta'><img src='img/stata.svg' width = 25 height = 25 alt = 'Stata'></a> <a href='{url}.rds'><img src='img/R.svg' width = 25 height = 25 alt = 'R'></a> <a href='{url}.sav'><img src='img/spss.svg' width = 25 height = 25 alt = 'SPSS'></a>")
...
df_list |> 
  ...
  arrange(Start) |>
  transmute(Start, End, Records, Records, Source, Download) |> 
  reactable::reactable(columns = col_defs, pagination = FALSE)
```
