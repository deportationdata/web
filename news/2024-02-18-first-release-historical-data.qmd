...
Our first release includes data in its original format from Immigrations and Customs Enforcement (ICE), Customs and Border Patrol (CBP), and the Executive Office for Immigration Review (EOIR). 
...
: This dataset includes apprehensions only of family units. 
